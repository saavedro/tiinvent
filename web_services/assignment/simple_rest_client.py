...
# Assignment: You need to implements missing parts of following functions:
# - get_employee()
# - update_employee()
# - delete_employee()
...
def get_employee(_id):
    ...
    raise NotImplemented("TODO implement getting single entry for given id")
...
def update_employee(_id, name, salary, age):
    ...
    raise NotImplemented("TODO implement updating of entry")
...
def delete_employee(_id):
    ...
    raise NotImplemented("TODO implement deleting of entry")
